...
public class AppointmentApiController{
    ...
    public ResponseEntity<Appointment> createAppointment(@RequestBody Map<String, String> request) {
        ...
        if (chartNo == null || doctorId == null) return ResponseEntity.badRequest().build();
        ...
        appt.setApptDate(LocalDate.parse(request.get("apptDate")));
        appt.setTimeSlot(request.get("timeSlot"));
        appt.setStatus("BOOKED");

        return ResponseEntity.status(201).body(appointmentRepo.save(appt));
    }
